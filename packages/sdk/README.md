...
See the repository [README](https://github.com/beyondspace-dev/remix-app#readme) and [Korean README](https://github.com/beyondspace-dev/remix-app/blob/main/README_ko.md) for project configuration, events, MQTT, and nativeEvents.
